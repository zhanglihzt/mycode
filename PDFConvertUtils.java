...
/**
 * Created by Tepusoft on 2017/10/21.
 */
public class PDFConvertUtils {
    private static final Logger LOG = Logger.getLogger(PDFConvertUtils.class);
    ...
    public static void main(String[] args)  {
        String source1 = "F:\\20171019173328.doc";
        String target1 = "F:\\20171019173328.pdf";

        PDFConvertUtils.word2pdf(source1, target1);
    ...
    public static void word2pdf(String source, String target) {
        ...
        try {
            ...
            System.out.println("Open DOC " + source);
            ...
            System.out.println("CONVERT DOC TO PDF :" + target);
